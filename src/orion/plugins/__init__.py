"""
Orion Agent — Plugin System (v6.4.0)

Migrated from Orion_MVP/core/plugin_api.py.

8 lifecycle hooks, event bus, manifest loading, skill registration.
...
class PluginManifest:
    ...
    def to_dict(self) -> Dict[str, Any]:
        return {
            ...
            "hooks": self.hooks, "commands": list(self.commands),
            "skills": list(self.skills), "config": self.config,
...
class PluginBase(ABC):
    ...
    def register_command(self, name: str, handler: Callable,
                         description: str = "", usage: str = "", category: str = ""):
    ...
    def register_skill(self, name: str, handler: Callable,
                       description: str = "", parameters: Optional[Dict] = None, category: str = ""):
...
class EventBus:
    ...
    def get_all_commands(self) -> List[PluginCommand]:
        ...
        for plugin in self._plugins.values():
            cmds.extend(plugin.get_commands())
        return cmds
