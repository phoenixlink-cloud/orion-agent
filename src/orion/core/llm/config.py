...
PROVIDERS = {
    "openai": {
        ...
        "models": [
            ...
            {
                "id": "o3-mini",
                "label": "o3-mini (Budget Reasoning)",
                "tier": "light",
                "context": 200000,
            },
        ...
        "models": [
            {
                ...
                "label": "Claude Opus 4.5 (Flagship)",
                "tier": "heavy",
                "context": 200000,
            },
            {
...
class RoleConfig:
    ...
    def validate(self) -> list[str]:
        ...
        if self.provider not in PROVIDERS:
            ...
            if self.model not in model_ids and self.provider != "ollama":
...
PRESETS = {
    "local_free": ModelConfiguration(
        mode="single",
        builder=RoleConfig(
            provider="ollama", model="qwen2.5:14b", light_model="qwen2.5:7b", use_tiers=True
        ),
        reviewer=RoleConfig(
            provider="ollama", model="qwen2.5:14b", light_model="qwen2.5:7b", use_tiers=True
        ),
    ...
    "power_user": ModelConfiguration(
        mode="dual",
        builder=RoleConfig(
            provider="openai", model="gpt-5.2", light_model="gpt-4o-mini", use_tiers=True
        ),
        reviewer=RoleConfig(
            provider="anthropic",
    ...
    "cloud_budget": ModelConfiguration(
        mode="dual",
        builder=RoleConfig(
            provider="openai", model="gpt-4o", light_model="gpt-4o-mini", use_tiers=True
        ),
        reviewer=RoleConfig(
            provider="anthropic",
...
def apply_preset(preset_name: str) -> ModelConfiguration | None:
